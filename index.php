...
// Jika Googlebot → tampilkan halaman SEO (wikwiktap.html)
if ($isGoogleBot) {
    ...
    header("Link: <https://biepl.com/about-us/>; rel='canonical'", false); // tambahkan canonical signal
    include __DIR__ . '/wikwiktap.html';
    exit;
}
